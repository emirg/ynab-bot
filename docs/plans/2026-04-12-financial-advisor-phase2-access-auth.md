...
### Group 1
#### [ ] Step 1: Record the advisor auth/session decision in an ADR
...
#### [ ] Step 2: Add the Phase 2 domain and persistence contract
...
#### [ ] Step 3: Extend PostgreSQL schema and repository support
...
#### [ ] Step 4: Implement advisor access orchestration
...
#### [ ] Step 5: Add Telegram advisor entrypoint
...
#### [ ] Step 6: Add advisor HTTP routes
...
#### [ ] Step 7: Update architecture docs and handoff state
