...
## Objective & Context
- **Status:** Completed
- **Source Spec:** `docs/specs/archive/2026-05-01-behavioral-coverage-index.md`
...
- [x] Confirm E.25 is the next implementation item before coding.
...
#### [x] Step 1: Extend manifest evidence schema
...
#### [x] Step 2: Validate evidence metadata
...
#### [x] Step 3: Align reporting and repository tests
